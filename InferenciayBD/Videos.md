...
### Grupo 2
Hacemos un pequeño tutorial sobre algorithm fairness, pasando por las definiciones y nociones de justicia (associational y causal fairness), analizando cuales no funcionan y cuales sí. Luego, revisamos como se puede hacer data management para lograr causal fairness desde tres puntos de vista disintos. En este [link](https://youtu.be/K2_WQlDvQ-Y) pueden ver el video.
